...
import org.jeecg.activiti.mapper.ActBusinessMapper;
import org.jeecg.activiti.service.IActBusinessService;
    ...
    public List<ActBusiness> approveList(HttpServletRequest request,ActBusiness param){
        ...
        actBusinessList.forEach(e -> {
            if(StrUtil.isNotBlank(e.getProcDefId())){
                ...
                e.setTableType(actProcess.getTableType());
                e.setOtherInfo(actProcess.getOtherInfo());
            }
            // 流程正在处理中时
