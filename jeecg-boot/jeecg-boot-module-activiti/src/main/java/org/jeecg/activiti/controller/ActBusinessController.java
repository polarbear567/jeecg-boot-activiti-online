...
import org.jeecg.activiti.entity.ActDoAndApplyVo;
...
public class ActBusinessController {
    ...
    public Result getActBusinessByTableInfo(@RequestParam(value = "tableName",defaultValue = "") String tableName, @RequestParam(value = "tableId",defaultValue = "") String tableId) {
