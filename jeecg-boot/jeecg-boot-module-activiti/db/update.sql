...
(
    ...
    table_type varchar(64) null comment '关联业务表类型',
...
create table act_z_form_component
(
    id      varchar(255) not null
        primary key,
    text    varchar(255) null comment '表单组件名称',
    component  varchar(255) null comment '表单组件路径',
    route_name     varchar(255) null comment '表单组件路径',
    business_table varchar(255) null comment '业务表名称',
    table_type varchar(64) null comment '业务表类型',
    other_info varchar(255) null comment '其他信息'
) CHARSET=utf8 comment '表单组件表';
...
INSERT INTO sys_permission (id, parent_id, name, url, component, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_route, is_leaf, keep_alive, hidden, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('1238331682929958921', '1238331160370012162', '表单组件管理', '/activiti/formComponent', 'activiti/formComponent', null, null, 1, null, '1', 9, 0, 'bars', 1, 1, 0, 0, null, 'admin', '2021-04-21 17:12:55', null, null, 0, 0, '1', 0);
