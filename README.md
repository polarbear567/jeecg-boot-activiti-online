...
> 由于没有上传数据库数据，所以如果你直接使用此demo在本地，应该会报错，demo只是参考，可以自己实际动手按照demo的步骤执行。生成的一些文件，配置文件的修改以及放置的位置可以参考这个[PR](https://github.com/polarbear567/jeecg-boot-activiti-online/pull/4/files)。
